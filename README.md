...
- [X] **All functionality implemented or mocked out** - the trivia game is fully mocked out and saves its scores, and is prepped for 3rd party input. The Welcome, User text uses the current username.
